...
import org.ufg.dto.ForceResendRequestDTO;
...
public class AvisoResource {
    ...
    @POST
    @Path("/force-resend")
    public Response forceResend(ForceResendRequestDTO body) {
        List<String> userIds = body != null ? body.getUserIds() : null;
        boolean bypassPreferences = body != null && body.isBypassPreferences();
        ForceResendResponseDTO result = avisoService.forceResendHoje(userIds, bypassPreferences);
