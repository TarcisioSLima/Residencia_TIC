...
class QueueConsumer:
    ...
    def _parse_payload(self, message: bytes) -> ExecutionPayload | None:
        ...
        raw_target = data.get("target_user_ids")
        target_user_ids = raw_target if isinstance(raw_target, list) and raw_target else None
        ...
        return ExecutionPayload(
            ...
            bypass_preferences=bool(data.get("bypass_preferences", False)),
        )
