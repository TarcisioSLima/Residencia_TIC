...
class DispatcherService:
    ...
    def dispatch(
        ...
        *,
        ...
        for canal_info in canais:
            ...
            if canal_nome == "email":
                stats["canais_email"] += 1
            else:
                stats["canais_whatsapp"] += 1
            ...
            try:
                ...
                if success:
                    stats["envios_sucesso"] += 1
                else:
                    stats["envios_falha"] += 1
                ...
                _log_safe(
                    ...
                    task=TASK_NAME_NOTIFICATIONS_DISPATCH,
                )
                status_name = "Falha"
                stats["envios_falha"] += 1

            self._register_envios(usuario.id, canal_id, alertas, status_name, execution_id=execution_id)
    ...
    def _register_envios(
        ...
        status_name: str,
        *,
        execution_id: str | Any | None = None,
    ) -> None:
        ...
        for alerta in alertas:
            ...
            try:
                ...
                _log_safe(
                    logger=self._logger,
                    execution_id=execution_id,
                    message="Falha ao registrar envio",
                    status=STATUS_ERROR,
                    extra={
                        "user_id": id_usuario,
                        "canal": id_canal,
