...
export class AvisoService {
  ...
  forceResend(userIds: string[], bypassPreferences: boolean = false): Observable<ForceResendResponse> {
    return this.http.post<ForceResendResponse>(`${this.apiUrl}/avisos/force-resend`, { userIds, bypassPreferences });
  }
